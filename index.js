//Clases
{
    class Jugador {
        ...
        // un getter devuelve algo relacionado con la propiedad o la propiedad
        get nombre() {
            return this.#nombre
        }
        //un setter nos permite asignarle un valor a nuestra propiedad con las condiciones que nosotro querramos
        set nombre(value) {
            this.#nombre = value
        }
        ...
        //esta es una propiedad privada ya que no tiene una propiedad definida pero dentro si usa unas
        get puntos() {
            return this.#puntaje
        }
